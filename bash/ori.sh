...
cd /data/jiali/vlul
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path configs/original/albef/retrieval_coco.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path configs/original/albef/vqa.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path configs/original/blip/nlvr.yaml
...
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=2 train.py --cfg-path configs/original/albef/snli_ve.yaml
